...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="//tei:teiCorpus/tei:TEI">
        ...
        <xsl:result-document method="xhtml" encoding="utf-8" href="cartas/{$sect_id}.html"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-6">
                            ...
                            <xsl:value-of select="tei:opener"></xsl:value-of>
                            <xsl:value-of select="tei:p"></xsl:value-of>
                            <xsl:value-of select="tei:closer"></xsl:value-of>
                            <h3>Metadatos</h3>
                            <ul>
                                <li>From whom: <xsl:value-of select="tei:titleStmt/tei:author"></xsl:value-of></li>
                                <li>From where: <xsl:value-of select="tei:publicationStmt"></xsl:value-of></li>
                                <li>To whom:</li>
                                <li>To where:</li>
                            </ul>
                        </div>
